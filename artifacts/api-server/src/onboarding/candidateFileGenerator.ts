...
import type { AgentCard, ImpactDeltaReport } from "./impactDeltaAnalyser.js";
...
RULES:
- Every YAML front matter MUST include: control_id, domain, owner, nist_control, approved_by: "PENDING", expires, risk_level
...
approved_by: PENDING
expires: ${expires}
mustCount: ${Math.max(3, permittedSkills.length)}
mustNotCount: 1
mayCount: 1
---
## ${agentCard.name} SOP
