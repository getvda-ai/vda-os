...
// ─────────────────────────────────────────────
const AGENT_DEFS = [
  { id: "availability",  name: "Availability Agent",       icon: "🔍", policy: "Hospitality-Revenue-PreBook-availability-agent.SOP.md",          endpoint: "/api/agents/availability" },
  ...
  { id: "checkout",      name: "Checkout Agent",            icon: "🚪", policy: "Hospitality-Operations-PostStay-checkout-agent.SOP.md",         endpoint: "/api/agents/checkout",
    params: [
  ...
  { id: "revenue",       name: "Revenue Reconciliation",    icon: "📊", policy: "Hospitality-Revenue-Book-rate-agent.AGENTS.md",                 endpoint: "/api/agents/revenue" },
];
